...
void main(void) {
	uint8_t time_array[] = {0x7E,0x01,0x5C,0xD2,0x93,0x9F,0x08,0x00,0x00,0x00,0x00,																							0x00,0x00,0x00,0x00,0x00,0x00,0x7E};
	uint16_t crc_data = 0;
  crc_data = CRC_16(0xffff,time_array+2,13);
	printf("crc_data = 0x%04x\n",crc_data);
}
