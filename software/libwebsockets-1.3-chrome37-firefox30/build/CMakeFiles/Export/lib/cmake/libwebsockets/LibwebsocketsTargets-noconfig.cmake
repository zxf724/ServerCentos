...
set_target_properties(websockets_shared PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_NOCONFIG "/usr/lib64/libz.so;/usr/lib64/libssl.so;/usr/lib64/libcrypto.so;dl;m"
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib64/libwebsockets.so.4.0.0"
  IMPORTED_SONAME_NOCONFIG "libwebsockets.so.4.0.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS websockets_shared )
list(APPEND _IMPORT_CHECK_FILES_FOR_websockets_shared "${_IMPORT_PREFIX}/lib64/libwebsockets.so.4.0.0" )
